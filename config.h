...
/* appearance */
static const unsigned int gappx = 15; // Горизонтальный отступ между окнами
		
int sidepad = 20; // или другое значение по умолчанию
int vertpad = 10; // или другое значение по умолчанию
